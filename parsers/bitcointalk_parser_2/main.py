...
import requests
from parsers.bitcointalk_parser_2.mongodb import dbCollection, insert_filtered_data
import sqlite3
import pymongo
import time 
...
class Main:
    ...
    def search_btc_mention(self, btc_addr=''):
        all_links = ' '
    ...
    def run(self):
        ...
        while (n_url < 3500000):
            ...
            try :
                ...
                db_payload['all_links_btc'] = self.search_btc_mention(db_payload['bitcoin_address'])
